<%@page import="com.cugb.javaee.chileme.utils.JSPOutput"%>
<%@page import="org.apache.jasper.tagplugins.jstl.core.If"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.cugb.javaee.chileme.utils.*"%>
<%@page import="com.cugb.javaee.chileme.bean.*"%>
						 ...
						 <br>
							...
							<form action="dishModify" method="post">
								...
								if(admin == null || !admin.getUsername().equals(ConfigFactory.readProperty("username"))){
									...
									DishDAO disDAO = (DishDAO) DAOFactory.newInstance("com.cugb.javaee.chileme.dao.IDishDAO");
